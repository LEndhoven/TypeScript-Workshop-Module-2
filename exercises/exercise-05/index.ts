 ...
 * The developer who wrote these functions made it convienient to support different types without losing type information.
 * It has been well received by the team, who is using this extensively.
 *
...
// Right now, only `number`, `string`, and `boolean` types are supported.
